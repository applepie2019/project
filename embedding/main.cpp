...
int main(int argc, char * argv[]) {
  ...
  if(argc > 1 && strncmp(argv[1], "-h", 3) == 0) {
    ...
    printf("type: type needs to be 'F' (FP only), 'B' (BP only), 'U' (UPD only) ");
    dist_fini();
    exit(0);
  }
  ...
  printf("Using: iters: %d N: %d E: %d M: %d S: %d P: %d alpha: %f type: %c \n", iters, N, E, M, S, P, alpha, type);
  ...
  double t0 = 0.0, t1 = 0.0, t2 = 0.0, t3 = 0.0, t4 = 0.0, t5 = 0.0, t6 = 0.0, t7 = 0.0, t8 = 0.0, t9 = 0.0, t10 = 0.0;
